...
<body>
  ...
  <tr>
    <td width="6%">&nbsp;</td>
    <td width="88%" bgcolor="#999999"  style="border-radius:50px; padding-left:15px; padding-right:15px; color:#FFFFFF; text-shadow:#000000 1px 1px 3px;"><strong>Data Member</strong>		   </td>
  ...
  <tr>
    ...
    <td ><div align="center">
          ...
          <table width="100%" border="0" align="center">
            <tr align="center">
			  ...
			  require("../scripts/connect.php");
				$view="select * from user order by username asc limit $offset,$dataPerPage";
				$nourut=0;
               ...
               <tr align=center bgcolor=#EEEEEE>
				...
				<td><a href='anggota_hapus.php?id=<?=$data[username];?>'><img src='../images/remove.png' border='0' title='Delete'></a></td></tr>
				 <?php	 }  ?>
		...
		if ($noPage > 1) echo "<a href='anggota.php?page=".($noPage-1)."' id='prev' style='color:#00CC33;'>Prev&nbsp;</a>";
		...
		for($page = 1; $page <= $jumPage; $page++)
		{
		         if ((($page >= $noPage - 3) && ($page <= $noPage + 3)) || ($page == 1) || ($page == $jumPage))
		         {
		            ...
		            else echo "<a href='anggota.php?page=".$page."' style='color:#00CC33;'>".$page."</a> ";
		            $showPage = $page;
		         }
		}
		//menampilkan link Next
		if ($noPage < $jumPage) echo "<a href='anggota.php?page=".($noPage+1)."' id='next' style='color:#00CC33;'>Next</a>";
		?>
		  </div>
          </div>
          </div></td>
...
<script>$(document).ready(function(){$('#member').attr('class','active')});</script>