...
<br/>
	...
	$tampil= mysql_query("SELECT * FROM produk where kategori='wanita' ORDER by id_produk DESC LIMIT $offset,$dataPerPage");
	...
	while($isi=mysql_fetch_assoc($tampil)){
      ...
      <div class="paging">
		...
		if ($noPage > 1) echo "<a href='produk.php?target=wanita&page=".($noPage-1)."' id='prev'>Prev&nbsp;</a>";
		...
		for($page = 1; $page <= $jumPage; $page++)
		{
		         if ((($page >= $noPage - 3) && ($page <= $noPage + 3)) || ($page == 1) || ($page == $jumPage))
		         {
		            ...
		            else echo "<a href='wanita.php?target=wanita&page=".$page."'>".$page."</a> ";
		            $showPage = $page;
		         }
		}
		//menampilkan link Next
		if ($noPage < $jumPage) echo "<a href='produk.php?target=wanita&page=".($noPage+1)."' id='next'>Next</a>";
		?>
		</div>